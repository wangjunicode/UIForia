...
<UITemplate>
    <Contents style.width=""parent(100)"" style.height=""parent(100)"" style.backgroundColor=""red"">
        <Children/>
    </Contents>
</UITemplate>
")]
public class ClippedPanel : UIElement, IDrawable {
    ...
    private static void AddQuad(Vector2 topLeft, Vector2 bottomRight, Color32 color) {
        s_VertexHelper.AddVert(new Vector3(topLeft.x, topLeft.y, 0), color, new Vector2());
    }
