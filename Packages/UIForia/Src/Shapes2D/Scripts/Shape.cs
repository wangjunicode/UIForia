    ...
    public class Shape : MonoBehaviour, IMaterialModifier {
        ...
        static Vector2[] GetVerticesForPreset(PolygonPreset preset) {
            if (preset == PolygonPreset.Triangle) {
                ...
                return new Vector2[] {
                    new Vector2(0, 0.5f), new Vector2(-0.15f, 0.2f),
                ...
                return new Vector2[] {
                    new Vector2(0.5f, 0), new Vector2(0, 0.4f),
        ...
        public class UserProps {
            ...
            /// </summary>
            [System.NonSerializedAttribute] public bool dirty = true;

            /// <summary> 
            /// Stores whether we need to recreate the poly map for optimized Polygon shape types.  
            /// You do not need to set this directly.
            /// </summary>
            [System.NonSerializedAttribute] public bool polyMapNeedsRegen = true;

            [SerializeField] [FormerlySerializedAs("blur")]
            ...
            public bool correctScaling {
                get { return _correctScaling; }
                set {
                    _correctScaling = value;
                    dirty = true;
                }
            }

            [SerializeField] [Range(0, 360)] private float _endAngle = 360;
            ...
            public float endAngle {
                ...
                set {
                    _endAngle = Mathf.Clamp(value, 0, 360);
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("fillColor")]
            ...
            [SerializeField] [FormerlySerializedAs("fillColor2")]
            ...
            [SerializeField] [FormerlySerializedAs("fillOffset")]
            ...
            [SerializeField] private bool _fillPathLoops = false;

            /// <summary>
            /// If shapeType is Path, this will cause any loops in the path to be filled.
            /// </summary>
            public bool fillPathLoops {
                get { return _fillPathLoops; }
                set {
                    _fillPathLoops = value;
                    dirty = true;
                }
            }

            [Range(0f, 360f)] [SerializeField] [FormerlySerializedAs("fillRotation")]
            ...
            [SerializeField] [FormerlySerializedAs("fillScale")]
            ...
            [SerializeField] [FormerlySerializedAs("fillTexture")]
            ...
            [SerializeField] [FormerlySerializedAs("fillType")]
            ...
            [SerializeField] [FormerlySerializedAs("gradientAxis")]
            ...
            [SerializeField] [FormerlySerializedAs("gradientStart")] [Range(0, 1)]
            ...
            [SerializeField] [FormerlySerializedAs("gradientType")]
            ...
            public float gridSize {
                ...
                set {
                    _gridSize = value < 0.01f ? 0.01f : value;
                    dirty = true;
                }
            }

            [SerializeField] private Vector2 _innerCutout;
            ...
            [SerializeField] private bool _invertArc = false;
            ...
            [SerializeField] [FormerlySerializedAs("lineSize")]
            ...
            public float lineSize {
                ...
                set {
                    _lineSize = value < 0.01f ? 0.01f : value;
                    dirty = true;
                }
            }

            [HideInInspector] [FormerlySerializedAs("numSides")]
            /// <summary>
            /// Obsolete since version 1.3; use polygonPreset instead.
            /// </summary>
            public int _obsoleteNumSides = -1;

            [SerializeField] [FormerlySerializedAs("outlineColor")]
            ...
            [SerializeField] [FormerlySerializedAs("outlineSize")]
            ...
            public float outlineSize {
                ...
                set {
                    _outlineSize = value < 0 ? 0 : value;
                    dirty = true;
                }
            }

            [SerializeField] private PathSegment[] _pathSegments = new PathSegment[] {
            ...
            [SerializeField] private float _pathThickness = 0.1f;

            /// <summary>
            /// If shapeType is Path, this is the thickness of the path in world units.
            /// </summary>
            public float pathThickness {
                get { return _pathThickness; }
                set {
                    _pathThickness = value < 0.01f ? 0.01f : value;
                    dirty = true;
                }
            }

            [SerializeField] private PolygonPreset _polygonPreset = PolygonPreset.Pentagon;
            ...
            [SerializeField] [FormerlySerializedAs("_vertices")]
            ...
            [SerializeField] [FormerlySerializedAs("roundness")]
            ...
            [SerializeField] [FormerlySerializedAs("roundnessBottomLeft")]
            ...
            public float roundnessBottomLeft {
                get { return _roundnessBottomLeft; }
                set {
                    _roundnessBottomLeft = value;
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("roundnessBottomRight")]
            ...
            public float roundnessBottomRight {
                get { return _roundnessBottomRight; }
                set {
                    _roundnessBottomRight = value;
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("roundnessPerCorner")]
            ...
            public bool roundnessPerCorner {
                get { return _roundnessPerCorner; }
                set {
                    _roundnessPerCorner = value;
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("roundnessTopLeft")]
            ...
            public float roundnessTopLeft {
                get { return _roundnessTopLeft; }
                set {
                    _roundnessTopLeft = value;
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("roundnessTopRight")]
            ...
            public float roundnessTopRight {
                get { return _roundnessTopRight; }
                set {
                    _roundnessTopRight = value;
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("shapeType")]
            ...
            public float startAngle {
                ...
                set {
                    _startAngle = Mathf.Clamp(value, 0, 360);
                    dirty = true;
                }
            }

            [SerializeField] [FormerlySerializedAs("triangleOffset")] [Range(0, 1)]
            ...
            [SerializeField] private bool _usePolygonMap = false;
        ...
        /// </summary>
        [HideInInspector] public bool wasConverted;
        ...
        /// </summary>
        [HideInInspector] public Vector3 preConvertedScale;
        ...
        Material IMaterialModifier.GetModifiedMaterial(Material oldMaterial) {
            ...
            if (mask != null) {
                ...
                if (i2 < i)
                    Debug.LogWarning("Warning (Object " + name +
                                     ") - If a Mask and a Shapes2D Shape are on the same GameObject, the Shape needs to be further down in the component order!  You can move components up and down using the gear icon in the Inspector.");
            }
