...
//        }
        Pass {
            ...
            #include "./Vertigo/VertigoSDFUtil.cginc"
...
//                
            ...
            fixed4 frag (v2f i) : SV_Target {
                ...
                fixed4 mainColor = SDFRectColor(sdfData, i.color);
                ...
                if(textureMode == TextureMode_TextureOnly) {
                    outputColor = textureColor;    
                }
                
                if(textureMode == TextureMode_TextureTint) {
                    
                }
                
                if(textureMode == TextureMode_TextureColor) {
                
                }
                
                if(textureMode == TextureMode_TextureColorTint) {
