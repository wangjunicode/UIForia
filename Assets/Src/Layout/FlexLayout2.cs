...
namespace Src.Layout {
    ...
    public class FlexLayout2 : Layout2 {
        ...
        private void RunFullColumnLayout(LayoutBox container) {
            ...
            float targetWidth = container.computedWidth;
            ...
            for (int i = 0; i < activeBoxes.Count; i++) {
                activeBoxes[i].SetRectFromLayout(widths[i].axisStart, heights[i].axisStart, widths[i].outputSize, heights[i].outputSize);
            }
