...
namespace Layout {
    ...
    public class FlexHorizontalTests {
        ...
        public void DistributeSpaceHorizontal_Default() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_DistributeSpaceHorizontal>()) {
        ...
        public void GrowUnconstrained() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_GrowUnconstrained>()) {
        ...
        public void GrowConstrained() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_GrowConstrained>()) {
        ...
        public void GrowWithExtraSpace() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_GrowWithExtraSpace>()) {
        ...
        public void RespectMarginHorizontal() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_RespectMarginHorizontal>()) {
        ...
        public void ShrinkUnconstrained() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_ShrinkUnconstrained>()) {
        ...
        public void ShrinkConstrained() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_ShrinkConstrained>()) {
        ...
        public void ShrinkWithOverflow() {
            using (MockApplication app = MockApplication.Setup<FlexHorizontal_ShrinkWithOverflow>()) {
