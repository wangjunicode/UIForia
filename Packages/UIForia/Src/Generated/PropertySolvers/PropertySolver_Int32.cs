...
namespace UIForia.Style {
    ...
    internal unsafe struct PropertySolverInfo_Int32 {

        public int enumTypeId;
        public bool isImplicitInherit;

        public PendingTransition* pendingTransitionList;
        public ActiveTransition_Int32* activeTransitionList;
        ...
        public DataList<PropertySolver_Int32.AnimationValue_Int32> animationValues;

    }

    internal static unsafe class PropertySolver_Int32 {

        public static void Invoke(ref PropertySolverInfo_Int32 solverInfo, in SolverParameters parameters, ref PropertySolverContext context, DataList<Int32> styleDatabase, Int32* outputTargets, int solverIndex, PropertyId propertyId, BumpAllocator* tempAllocator, bool contextual) {
            ...
            if (contextual) {
                ...
                for (int i = 0; i < solverInfo.animationValues.size; i++) {
                    ref AnimationValue_Int32 value = ref solverInfo.animationValues[i];
                    outputTargets[value.elementId.index] = value.currentValue;
                }

            }

            BumpList<ActiveTransition_Int32> purgatoryTransitionList = SetupFrameData(
                ref solverInfo,
                parameters,
                tempAllocator,
                scratchMap,
            ...
            BumpList<Int32Write> writeBuffer = tempAllocator->AllocateList<Int32Write>(maxWriteBufferSize);
            ...
            for (int i = 0; i < solverInfo.activeTransitionCount; i++) {
                ref ActiveTransition_Int32 transition = ref solverInfo.activeTransitionList[i];
            ...
            BumpList<Int32> transitionPrevValues = tempAllocator->AllocateList<Int32>(changedTransitionIds.size);
            ...
            if (keyFramesProperties.size > 0) {
                ...
                if (contextual) {
                    ...
                    for (int i = 0; i < keyFramesProperties.size; i++) {
                        ...
                        Int32 next = keyFrameProp.next == KeyFrameResult.k_Current ? outputTargets[keyFrameProp.elementId.index] : styleDatabase[keyFrameProp.next];
                        Int32 prev = keyFrameProp.prev == KeyFrameResult.k_Current ? outputTargets[keyFrameProp.elementId.index] : styleDatabase[keyFrameProp.prev];
                        ...
                        keyFramesResultValues[i] = InterpolatedStyleValue.FromInt32(next, prev, keyFrameProp.t);
            ...
            if (changedTransitionIds.size != 0) {
                ...
                if (contextual) {
                    ...
                    for (int i = 0; i < transitionPrevValues.size; i++) {
                        ...
                        ActiveTransition_Int32 active = new ActiveTransition_Int32 {
                        ...
                        if (scratchMap.Get(elementId)) {
                            ActiveTransition_Int32 prevTransition = FindInPurgatory(elementId, purgatoryTransitionList);
                            float progress = math.clamp(prevTransition.elapsed / (float) prevTransition.definition.duration, 0, 1);
                            active.prev = ActiveTransition_Int32.ResolveTransitionResetValue(solverInfo.enumTypeId, parameters, prevTransition, progress);
                        }
                        ...
                        keyFramesResultValues.Add(InterpolatedStyleValue.FromInt32(outputTargets[elementId.index], transitionPrevValues.array[i], 0));
        ...
        public struct AnimationValue_Int32 {
        ...
        private static void WriteDefaultValues(in PropertySolverInfo_Int32 solverInfo, in SolverParameters parameters, Int32 defaultValue, Int32* outputTargets, BumpAllocator* tempAllocator, ElementMap previousDefinitionMap, ElementMap definitionMap, ElementMap changeMap) {
            ...
            for (int i = 0; i < defaults.size; i++) {
                ...
                Int32* dest = outputTargets + defaults.array[i].index;
        ...
        private static void FlushWriteBuffer(in SolverParameters parameters, Int32* outputTargets, BumpList<Int32Write> writeBuffer) {

            // maybe sort the write buffer by elementId for better write locality?

            for (int i = 0; i < writeBuffer.size; i++) {
                ref Int32Write entry = ref writeBuffer.array[i];
        ...
        private static void RemoveExpiredTransitions(ref PropertySolverInfo_Int32 solverInfo, in PropertySolverContext context) {
            for (int i = 0; i < solverInfo.activeTransitionCount; i++) {
                ref ActiveTransition_Int32 transition = ref solverInfo.activeTransitionList[i];
        ...
        private static BumpList<ActiveTransition_Int32> SetupFrameData(ref PropertySolverInfo_Int32 solverInfo, in SolverParameters parameters, BumpAllocator* tempAllocator, ElementMap scratch, ElementMap inheritMap, ElementMap previousDefinitionMap) {
            ...
            BumpList<ActiveTransition_Int32> purgatoryTransitionList = tempAllocator->AllocateList<ActiveTransition_Int32>(solverInfo.activeTransitionCount);
        ...
        private static void UpdateInstanceProperties(ref PropertySolverContext context, Int32* outputTargets, InstancePropertyUpdateList instanceUpdateList, ElementMap definitionMap, ElementMap activeTransitionMap, ElementMap changeMap, ref BumpList<Int32Write> writeBuffer) {
            for (int i = 0; i < instanceUpdateList.size; i++) {
                ...
                writeBuffer.array[writeBuffer.size++] = new Int32Write() {
        ...
        private static void UpdateActiveTransitions(in PropertySolverInfo_Int32 solverInfo, in SolverParameters parameters, ElementMap animationMap, ElementMap resetTransitionMap, ref BumpList<Int32Write> writeBuffer) {
            ...
            for (int i = 0; i < solverInfo.activeTransitionCount; i++) {
                ...
                if (resetTransitionMap.Get(transition.elementId)) {
                    ...
                    transition.prev = ActiveTransition_Int32.ResolveTransitionResetValue(solverInfo.enumTypeId, parameters, transition, progress);
            ...
            for (int i = 0; i < solverInfo.activeTransitionCount; i++) {
                ...
                writeBuffer.array[writeBuffer.size++] = new Int32Write() {
                    elementId = transition.elementId,
                    value = ActiveTransition_Int32.Interpolate(solverInfo.enumTypeId, parameters, transition, progress)
                };
        ...
        private static Int32 FindInWriteBuffer(ElementId elementId, BumpList<Int32Write> list) {
            int idx = 0;
        ...
        // value is 100% in the buffer 
        private static ActiveTransition_Int32 FindInPurgatory(ElementId elementId, BumpList<ActiveTransition_Int32> list) {
        ...
        private static Int32 ResolveAnimationVariable(ushort variableNameId, Int32 defaultValue, CheckedArray<TraversalInfo> traversalInfo, CheckedArray<ValueVariable> variables, ElementId elementId) {
            ...
            for (int i = start; i < end; i++) {
                ...
                if (depthDiff > nearestDistance || !variable.TryConvertToInt32(out Int32 resolved)) {
                    continue;
                }
        ...
        private static void ResolveVariables(int enumTypeId, CheckedArray<TraversalInfo> traversalInfo, ref DataList<PropertyContainer> propertyList, CheckedArray<ValueVariable> variables, ref BumpList<Int32Write> writeBuffer, ElementMap changeMap, Int32* outputTargets) {
        ...
        private static void HandlePropertyUpdates(
            ...
            ref BumpList<Int32Write> writeBuffer) {
            ...
            for (int i = 0; i < usedUpdateSize; i++) {
                ...
                Int32 variableDefaultValue = styleDatabase[usedUpdates[i].dbValueLocation];
            ...
            Int32* values = tempAllocator->Allocate<Int32>(usedUpdateSize);
            Int32* dbValues = tempAllocator->Allocate<Int32>(usedUpdateSize);
            ...
            for (int i = 0; i < updateCount; i++) {
                ...
                Int32 databaseValue = styleDatabase[update.dbValueLocation];

                inheritMap.Unset(update.elementId); // todo -- how do I handle inherit? db value? or some other place?

                Int32* current = outputTargets + update.elementId.index;
