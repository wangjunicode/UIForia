...
namespace UIForia.Style {
    ...
    public partial struct PropertyId {
        ...
        public static readonly PropertyId BackgroundColor = new PropertyId(0, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundFit = new PropertyId(1, PropertyFlags.BuiltIn);
        public static readonly PropertyId BackgroundImage = new PropertyId(2, PropertyFlags.BuiltIn);
        public static readonly PropertyId BackgroundImageOffsetX = new PropertyId(3, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundImageOffsetY = new PropertyId(4, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundImageRotation = new PropertyId(5, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundImageScaleX = new PropertyId(6, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundImageScaleY = new PropertyId(7, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundImageTileX = new PropertyId(8, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundImageTileY = new PropertyId(9, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BackgroundTint = new PropertyId(10, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderBottom = new PropertyId(11, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderColorBottom = new PropertyId(12, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderColorLeft = new PropertyId(13, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderColorRight = new PropertyId(14, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderColorTop = new PropertyId(15, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderLeft = new PropertyId(16, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderRadiusBottomLeft = new PropertyId(17, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderRadiusBottomRight = new PropertyId(18, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderRadiusTopLeft = new PropertyId(19, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderRadiusTopRight = new PropertyId(20, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderRight = new PropertyId(21, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId BorderTop = new PropertyId(22, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId ClipBehavior = new PropertyId(23, PropertyFlags.BuiltIn);
        public static readonly PropertyId ClipBounds = new PropertyId(24, PropertyFlags.BuiltIn);
        public static readonly PropertyId Cursor = new PropertyId(25, PropertyFlags.BuiltIn);
        public static readonly PropertyId MarginBottom = new PropertyId(26, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MarginLeft = new PropertyId(27, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MarginRight = new PropertyId(28, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MarginTop = new PropertyId(29, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MaxHeight = new PropertyId(30, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MaxWidth = new PropertyId(31, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MinHeight = new PropertyId(32, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId MinWidth = new PropertyId(33, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId Opacity = new PropertyId(34, PropertyFlags.BuiltIn | PropertyFlags.Inherited | PropertyFlags.Animated);
        public static readonly PropertyId OverflowX = new PropertyId(35, PropertyFlags.BuiltIn);
        public static readonly PropertyId OverflowY = new PropertyId(36, PropertyFlags.BuiltIn);
        public static readonly PropertyId PaddingBottom = new PropertyId(37, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId PaddingLeft = new PropertyId(38, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId PaddingRight = new PropertyId(39, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId PaddingTop = new PropertyId(40, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId Painter = new PropertyId(41, PropertyFlags.BuiltIn);
        public static readonly PropertyId PointerEvents = new PropertyId(42, PropertyFlags.BuiltIn);
        public static readonly PropertyId PreferredHeight = new PropertyId(43, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId PreferredWidth = new PropertyId(44, PropertyFlags.BuiltIn | PropertyFlags.Animated);
        public static readonly PropertyId Visibility = new PropertyId(45, PropertyFlags.BuiltIn | PropertyFlags.Inherited);
