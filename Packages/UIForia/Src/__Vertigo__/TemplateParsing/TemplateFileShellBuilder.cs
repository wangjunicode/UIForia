...
namespace UIForia {
    ...
    public class TemplateFileShellBuilder {
        ...
        private TemplateASTBuilder CreateTextNode(TemplateASTBuilder parentId, LineInfo lineInfo, IList<AttributeDefinition2> attributes, TemplateNodeType nodeType) {
            ...
            if (nodeType != TemplateNodeType.Text && nodeType != TemplateNodeType.TextSpan) {
                nodeType = TemplateNodeType.Text;
            }
        ...
        public struct TemplateASTBuilder {
            ...
            public TemplateASTBuilder AddTextSpanChild(List<AttributeDefinition2> attributes, LineInfo lineInfo) {
                return templateFileShellBuilder.CreateTextNode(this, lineInfo, attributes, TemplateNodeType.TextSpan);
            }
