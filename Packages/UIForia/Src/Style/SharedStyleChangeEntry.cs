...
namespace UIForia.Style {
    ...
    public unsafe struct SharedStyleChangeEntry {
        ...
        public bool hadStyleListUpdate;
        public bool hadStateUpdate;
        public bool hadStyledAttributeUpdate;

        public SharedStyleChangeEntry(ElementId elementId, StyleState2Byte state, RangeInt styleIdRange) : this() {
