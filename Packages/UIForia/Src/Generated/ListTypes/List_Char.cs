...
namespace UIForia.ListTypes {
    ...
    [System.Diagnostics.DebuggerTypeProxy(typeof(DebugView_Char))]
    internal unsafe struct List_Char : IBasicList<Char>, IDisposable {
        ...
        public struct Shared : System.IDisposable {
            ...
            public Shared(int initialCapacity, Allocator allocator, bool clear = false) {
                this.state = Util.Unsafe.TypedUnsafe.Malloc<List_Char>(1, allocator);
            ...
            public void FilterSwapRemove<TFilter>(TFilter filter) where TFilter : Util.Unsafe.IListFilter<Char> {
