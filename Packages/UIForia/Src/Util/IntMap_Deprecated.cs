...
namespace UIForia.Util {
    ...
    public class IntMap_Deprecated<T> {
        ...
        public IntMap_Deprecated() : this(7) { }

        public IntMap_Deprecated(int capacity) {
        ...
        public IntMap_Deprecated(IDictionary<int, T> collection) : this(7) {
