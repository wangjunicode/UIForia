...
namespace UIForia.Compilers {
    ...
    public class StyleParseCache {

        private Dictionary<string, StyleFileShell> styleMap;
        private string cacheFilePath;

        internal StyleParseCache() {
            styleMap = new Dictionary<string, StyleFileShell>(128);
        }
        ...
        private void BuildCache() {
            ...
            LightList<StyleFileShell> files = new LightList<StyleFileShell>(list.size);
