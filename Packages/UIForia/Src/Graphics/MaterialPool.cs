...
namespace Vertigo {
    ...
    public class MaterialPool {
        ...
        private readonly Dictionary<string, LightList<VertigoMaterial>> instanceMaterialMap;
        private readonly Dictionary<string, LightList<VertigoMaterial>> sharedMaterialMap;
        private static readonly LightList<string> s_Keywords = new LightList<string>(4);

        private LightList<string> sortContainer;

        public MaterialPool() {
            instanceMaterialMap = new Dictionary<string, LightList<VertigoMaterial>>();
            sharedMaterialMap = new Dictionary<string, LightList<VertigoMaterial>>();
        }
        ...
        private static VertigoMaterial CreateMaterial(string materialName, IList<string> keywords) {
            // todo -- if we looked for this material before, don't do another resource load call
