...
namespace UIForia.Graphics {
     ...
     [BurstCompile]
    internal unsafe struct BuildBatchGeometryJob2 : IJob {
        ...
        private void Run(int start, int end) {
            ...
            for (int batchIdx = start; batchIdx < end; batchIdx++) {
                ...
                // todo -- if transforming vertices, check if the matrix has rotation / scale before blindly doing big matrix operations
                ...
                if (batchEnd - batchStart == 1) {
                    ...
                    // todo -- avoid copy & work if only 1 thing in the batch
