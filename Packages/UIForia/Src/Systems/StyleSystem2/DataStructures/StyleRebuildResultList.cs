...
namespace UIForia {
    ...
    public unsafe struct StyleRebuildResult {
        ...
        public bool TryGetProperty(PropertyId propertyId, out PropertyData retn) {
            ...
            PropertyId* keys = (PropertyId*) properties;
            PropertyData* values = (PropertyData*) (keys + propertyCount);
    ...
    public unsafe struct StyleRebuildResultList : IPerThreadCompatible, IMergeableToList<StyleRebuildResult> {
        ...
        public void InitializeForThread(Allocator allocator) {
            this.infoList = new PagedList<StyleRebuildResult>(64, allocator).GetStatePointer();
            this.keyList = new PagedList<PropertyId>(256, allocator).GetStatePointer();
            this.valueList = new PagedList<PropertyData>(256, allocator).GetStatePointer();
        }
        ...
        public void Add(ElementId elementId, int propertyCount, PropertyId* keys, PropertyData* values) {
        ...
        public PagedList<StyleRebuildResult> GetResultList() {
            return new PagedList<StyleRebuildResult>(infoList);
        }
