...
namespace UIForia.Editor.FontLoading {
    ...
    public class FontLoader {
        ...
        public class TMPro_FontPlugin {
            ...
            [DllImport("UIForia_TMPro_Plugin")]
            ...
            [DllImport("UIForia_TMPro_Plugin")]
            internal static extern void SendCancellationRequest(CancellationRequestType request);
        ...
        internal enum CancellationRequestType : byte {

            None = 0x0,
            CancelInProgress = 0x1,
            WindowClosed = 0x2
