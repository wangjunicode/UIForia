...
namespace UIForia.Parsing {
    ...
    public class TemplateParserXML2 : TemplateParser {
        ...
        public TemplateParserXML2() {
            textContent = new StringBuilder(128);
            attributes = new List<AttributeDefinition2>(16);
            templateFileShellBuilder = new TemplateFileShellBuilder();
        }
        ...
        public override bool TryParse(string filePath, out TemplateFileShell templateShell) {
            XElement root;
