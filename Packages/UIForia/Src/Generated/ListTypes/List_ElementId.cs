...
namespace UIForia.ListTypes {
    ...
    [System.Diagnostics.DebuggerTypeProxy(typeof(DebugView_ElementId))]
    internal unsafe struct List_ElementId : IBasicList<ElementId>, IDisposable {
        ...
        public struct Shared : System.IDisposable {
            ...
            public Shared(int initialCapacity, Allocator allocator, bool clear = false) {
                this.state = Util.Unsafe.TypedUnsafe.Malloc<List_ElementId>(1, allocator);
            ...
            public void FilterSwapRemove<TFilter>(TFilter filter) where TFilter : Util.Unsafe.IListFilter<ElementId> {
