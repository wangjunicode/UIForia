...
// using TemplateCache = UIForia.Parsing.TemplateCache;
//
...
//
//             ElementNode child = AssertAndReturn<ElementNode>(templateRootRoot[0]);
...
//
//             ElementNode terminalNode = AssertAndReturn<ElementNode>(text[0]);
...
//             Assert.AreEqual(1, templateRootRoot.ChildCount);
//
//             ElementNode child = AssertAndReturn<ElementNode>("Div", templateRootRoot[0]);
...
//             });
//             Assert.IsTrue(exception.Message.Contains(XMLTemplateParser.UnresolvedTagName("XMLTemplateParsing_Namespaces.xml", new TemplateLineInfo(11, 10), "NotHere:Div").Message));
//         }
//
//         [Template("XMLTemplateParsing_UseDynamicElement.xml")]
...
//         }
//
//         [Template("XMLTemplateParsing_UseDynamicElement.xml#generic_main")]
...
//         }
//
//         [Template("XMLTemplateParsing_UsingElement.xml")]
...
//             Assert.IsInstanceOf<T>(b);
//             T a = (T) b;
//             if (!string.IsNullOrEmpty(a.moduleName)) {
//                 Assert.AreEqual(tagName, a.moduleName + ":" + a.tagName);
//             }
//             else {
