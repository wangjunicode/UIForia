...
namespace Tests {
    ...
    public class ExpressionCompilerTests {
        ...
        private static ContextDefinition simpleRootContext = new ContextDefinition(typeof(SimpleRoot));
        private static ContextDefinition nullContext = new ContextDefinition(typeof(EmptyTarget));

        [SetUp]
        public void Setup() {
            simpleRootContext = new ContextDefinition(typeof(SimpleRoot));
        ...
        public void AccessExpression_InnerContext_Field() {
            ...
            simpleRootContext.SetAliasToType("$item", typeof(ValueContainer));
        ...
        public void AccessExpression_ArrayIndexAsAlias() {
            ...
            target.someArray.Add(111);
            ExpressionContext ctx = new ExpressionContext(target);
            simpleRootContext.SetAliasToType("$i", typeof(int));
            ctx.SetIntAlias("$i", 2);
