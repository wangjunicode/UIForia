...
namespace MouseEvents {
    ...
    public class MouseEventTests {
        ...
        public void MouseDown_WithPropagation() {
            using (MockApplication application = MockApplication.Setup<InputSystemTestThing>()) {
                application.Update();
        ...
        public void MouseDown_StopPropagation() {
            using (MockApplication testView = MockApplication.Setup<InputSystemTestThing2>()) {
                testView.Update();
