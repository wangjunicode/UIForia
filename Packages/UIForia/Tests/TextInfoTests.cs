...
//        TextInfo t = new TextInfo(new TextSpanOld("hello", new SVGX.SVGXTextStyle()));
...
//            new TextSpanOld("hello "),
//            new TextSpanOld("world")
//        );
...
//            new TextSpanOld("world")
//        );
//        t.UpdateSpan(0, new TextSpanOld(newValue));
...
//
//        TextInfo t = new TextInfo(
//            new TextSpanOld("this is a longer string "),
//            new TextSpanOld("world")
//        );
//
//        t.UpdateSpan(0, new TextSpanOld(newValue));
...
//        );
//
//        t.UpdateSpan(1, new TextSpanOld(newValue));
...
//
//        TextInfo t = new TextInfo(
//            new TextSpanOld("some words here "),
//            new TextSpanOld("some other stuff "),
//            new TextSpanOld("this is a longer string")
//        );
//
//        t.UpdateSpan(2, new TextSpanOld(newValue));
...
//        TextInfo t = new TextInfo(
//            new TextSpanOld("some words here "),
//            new TextSpanOld("this is the word "),
//            new TextSpanOld("some other stuff")
//        );
//
//        t.UpdateSpan(1, new TextSpanOld(newValue));
