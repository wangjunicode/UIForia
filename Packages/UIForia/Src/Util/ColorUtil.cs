...
namespace UIForia.Util {
    ...
    public static class ColorUtil {
        ...
        public static Color hotterpink = new Color32(255, 8, 77, 255);
        ...
        public static Color rebeccapurple = new Color32(102, 51, 153, 255);
        ...
        public static Color lightslategrey = new Color32(119, 136, 153, 255);
        ...
        public static Color darkslategrey = new Color32(47, 79, 79, 255);
        ...
        public static bool TryParseColorName(CharSpan charSpan, out Color32 color, out int nameLength) {
            ...
            int spanLength = charSpan.rangeEnd - charSpan.rangeStart;
            unsafe {
                while (num1 <= num2) {
                    int index1 = num1 + (num2 - num1 >> 1);

                    ref ColorLookup lookup = ref s_ColorList[index1];
                    int num3 = StringUtil.CharCompareOrdinal(lookup.name, charSpan.data, charSpan.rangeStart, spanLength);
