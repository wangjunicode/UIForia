...
namespace UIForia.Parsing {
    ...
    public class TemplateShell_Deprecated {
        ...
        public TemplateShell_Deprecated(Module module, string filePath) {
            this.module = module;
        ...
        public bool ReportError(LineInfo lineInfo, string error) {
            // todo -- diagnostics
