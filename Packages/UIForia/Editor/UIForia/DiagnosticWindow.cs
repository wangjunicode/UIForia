...
namespace UIForia.Editor {
    ...
    public class UIForiaDiagnosticWindow : EditorWindow {
        ...
        private readonly GUIContent clearButtonContent = new GUIContent("Clear");
        private readonly GUIContent collapseButtonContent = new GUIContent("Collapse");
        private readonly GUIContent clearOnPlayContent = new GUIContent("Clear On Play");
        private readonly GUIContent errorPauseContent = new GUIContent("Error Pause");
        ...
        private void DrawMenuBar() {
            ...
            GUILayout.Button(clearButtonContent, EditorStyles.toolbarButton, GUILayout.Width(35));
            GUILayout.Space(5);

            collapse = GUILayout.Toggle(collapse, collapseButtonContent, EditorStyles.toolbarButton, GUILayout.Width(50));
            clearOnPlay = GUILayout.Toggle(clearOnPlay, clearOnPlayContent, EditorStyles.toolbarButton, GUILayout.Width(90));
            errorPause = GUILayout.Toggle(errorPause, errorPauseContent, EditorStyles.toolbarButton, GUILayout.Width(80));
