...
namespace UIForia.Compilers {
    ...
    public partial class StyleBindingCompiler {
        ...
        private static readonly EnumAliasSource<UIForia.Layout.SpaceDistribution> s_EnumSource_SpaceDistribution = new EnumAliasSource<UIForia.Layout.SpaceDistribution>();
...
case "visibility":
                ...
                case "alignitemshorizontal":
                    return new UIForia.Bindings.StyleBindings.StyleBinding_float("AlignItemsHorizontal", UIForia.Rendering.StylePropertyId.AlignItemsHorizontal, targetState.state, Compile<float>(value, null));                
                case "alignitemsvertical":
                    return new UIForia.Bindings.StyleBindings.StyleBinding_float("AlignItemsVertical", UIForia.Rendering.StylePropertyId.AlignItemsVertical, targetState.state, Compile<float>(value, null));                
                case "fititemsvertical":
                ...
                case "distributeextraspacehorizontal":
                    return new UIForia.Bindings.StyleBindings.StyleBinding_SpaceDistribution("DistributeExtraSpaceHorizontal", UIForia.Rendering.StylePropertyId.DistributeExtraSpaceHorizontal, targetState.state, Compile<UIForia.Layout.SpaceDistribution>(value, s_EnumSource_SpaceDistribution));                
                case "distributeextraspacevertical":
                    return new UIForia.Bindings.StyleBindings.StyleBinding_SpaceDistribution("DistributeExtraSpaceVertical", UIForia.Rendering.StylePropertyId.DistributeExtraSpaceVertical, targetState.state, Compile<UIForia.Layout.SpaceDistribution>(value, s_EnumSource_SpaceDistribution));                
                ...
                case "layoutfithorizontal":
                    return new UIForia.Bindings.StyleBindings.StyleBinding_LayoutFit("LayoutFitHorizontal", UIForia.Rendering.StylePropertyId.LayoutFitHorizontal, targetState.state, Compile<UIForia.Layout.LayoutFit>(value, s_EnumSource_LayoutFit));                
                case "layoutfitvertical":
                    return new UIForia.Bindings.StyleBindings.StyleBinding_LayoutFit("LayoutFitVertical", UIForia.Rendering.StylePropertyId.LayoutFitVertical, targetState.state, Compile<UIForia.Layout.LayoutFit>(value, s_EnumSource_LayoutFit));                
                case "minwidth":
