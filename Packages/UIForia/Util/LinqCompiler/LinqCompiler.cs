...
namespace UIForia.Compilers {
    ...
    public class LinqCompiler {
        ...
        public LinqCompiler() {
            this.typeResolver = TypeResolver.Default;
...
//            }
        ...
        private bool ResolveNamespaceChain(MemberAccessExpressionNode node, out int start, out string resolvedNamespace) {
...
//                AddStatement(Expression.Return(returnLabel, Expression.Default(returnType), returnType));
        ...
        private Expression VisitLocalVariable(LocalVariableNode node) {
            ...
            if (node.typeLookup.typeName == null) {
                ...
                variableType = typeResolver.ResolveType(node.typeLookup, namespaces, null);
            }
