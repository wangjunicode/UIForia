...
namespace UIForia.Parsing.Expressions.AstNodes {
    ...
    public abstract class ASTNode {
        ...
        protected static readonly ObjectPool<StringInterpolationNode> s_StringInterpolationPool = new ObjectPool<StringInterpolationNode>();
        ...
        public static ASTNode StringInterpolationNode(string rawValue, StructList<StringInterpolationPart> parts) {
            StringInterpolationNode node = s_StringInterpolationPool.Get();
            node.rawValue = rawValue;
            node.parts = parts;
            node.type = ASTNodeType.StringInterpolation;
            return node;
        }

        public static ASTNode StyleIdNode(string sheetName, string styleName) {
            IdentifierNode idNode = s_IdentifierPool.Get();
            idNode.name = styleName;
            idNode.secondary = sheetName;
            idNode.type = ASTNodeType.StyleIdentifier;
            return idNode;
        } 
        
        public static ASTNode StyleIdNode(string styleName) {
            IdentifierNode idNode = s_IdentifierPool.Get();
            idNode.name = styleName;
            idNode.secondary = null;
            idNode.type = ASTNodeType.StyleIdentifier;
            return idNode;
        }
    ...
    public class OutNode : ASTNode {
        ...
        public OutNode(ASTNode expression) {
            this.type = ASTNodeType.Out;
